...
public final class BundleInfo implements WithConciseDebugString {
    ...
    public Stream<ResInfo> resources(ResInfo.EffectiveNameGenerator effectiveNameGenerator) {
        return Arrays.stream(bundleClass.getMethods()).map(method -> ResInfo.reflect(this, method, effectiveNameGenerator));
    }
    ...
    public boolean equals(Object o) {
        ...
        return bundleClass.equals(that.bundleClass) && baseName.equals(that.baseName) && effectiveBaseName.equals(that.effectiveBaseName);
    }

...
public class ResolvableList implements Resolvable {
    ...
    private ResolvableList(Class<? extends ResolvableListConfiguration> configuration, List<? extends Resolvable> elements) {
        ...
        public @Nullable String getText(@Nullable Locale locale, NotFoundConfig.WithNullAndDefault notFoundConfig) {
            ...
            switch (numberOfMessages) {
                ...
                default:
                    ...
                    var itemsStream = ResolvableList.this.elements.stream().map(resolvable -> {
